  ...
  const categories: Category[] = [
    {
      ...
      emoji: "👤",
      description:
        "Zachytím vaši osobnost a přirozenou krásu v portrétech, které vyprávějí příběh.",
    ...
    },
    {
      ...
      emoji: "💍",
      description:
        "Dokumentuji váš velký den se zaměřením na autentické momenty a emoce.",
    ...
    },
    {
      ...
      emoji: "👨‍👩‍👧",
      description:
        "Přirozené rodinné fotografie plné lásky, smíchu a jedinečných okamžiků.",
    ...
    },
    {
      ...
      emoji: "🏞️",
      description:
        "Krajinářská fotografie zachycující krásu přírody v různých ročních obdobích.",
  ...
  return (
    <section id="categories" className="py-20 md:py-28 bg-gray-50">
      <div className="container-modern">
        ...
        >
          <h2 className="heading-font text-3xl md:text-4xl mb-4">
            Co fotografuji
          </h2>
          <p className="text-gray-600 max-w-3xl mx-auto">
            Specializuji se na několik fotografických stylů. Prohlédněte si mé
            portfolio a zjistěte, jak mohu zachytit vaše vzácné okamžiky.
          </p>
        </motion.div>
